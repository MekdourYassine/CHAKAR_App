  ...
  object sPanel1: TsPanel
    ...
    object sGroupBox1: TsGroupBox
      ...
      object DBGrid1: TDBGrid
        ...
        Height = 449
        Cursor = crHandPoint
        DataSource = DataModule2.DataSource_papier
        ...
        Columns = <
          ...
          item
            Expanded = False
            FieldName = 'longueur_papier'
            Title.Caption = 'Long/Nbre pi'#232'ces (Restantes) '
            Width = 250
            Visible = True
          end
          item
          ...
          item
            Expanded = False
            FieldName = 'largeur_papier'
            Title.Caption = 'Longueur /Pi'#232'ces'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'qte_rouleau'
            Title.Caption = 'Qte rouleau/Nbre Rams'
            Visible = True
          end>
      end
    ...
    object sGroupBox3: TsGroupBox
      ...
      object DBGrid2: TDBGrid
        ...
        Height = 449
        Cursor = crHandPoint
        DataSource = DataModule2.DataSource_ancre
        Options = [dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgRowSelect, dgConfirmDelete, dgCancelOnExit, dgMultiSelect]
        ReadOnly = True
        TabOrder = 0
        TitleFont.Charset = ANSI_CHARSET
    ...
    object sGroupBox7: TsGroupBox
      ...
      Width = 1353
      Height = 689
      Caption = 'Etat des factures proformas'
      TabOrder = 2
      SkinData.SkinSection = 'FORMTITLE'
      ...
      object DBGrid3: TDBGrid
        ...
        Columns = <
          ...
          item
            ...
            Title.Caption = 'Montant_HT'
            Width = 200
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'prix_total_performat'
            Title.Caption = 'Montant_TTC'
            Width = 200
            Visible = True
          end>
      end
